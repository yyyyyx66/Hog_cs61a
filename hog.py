...
def take_turn(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    "*** YOUR CODE HERE ***"
    if num_rolls>0:
        sorce=roll_dice(num_rolls,dice)
    elif num_rolls==0:
        sorce=boar_brawl(player_score,opponent_score)
    return sorce
    # END PROBLEM 3
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def strategya(player_score, opponent_score):
        return n
    return strategya
    # END PROBLEM 6
...
def is_always_roll(strategy, goal=GOAL):
    ...
    while score<goal:
        while opponent_score<goal:
            if strategy(score,opponent_score)!=strategy(score,opponent_score+1):
                return False
            opponent_score+=1
        opponent_score=0
        score+=1
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    dice_averaged=make_averaged(roll_dice,1000)
    n=1
    result=1
    while n<=10:
        if dice_averaged(result,dice)<dice_averaged(n,dice):
            result=n
        n+=1
    return result
    # END PROBLEM 9
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    if sus_update(0,score,opponent_score,6)-score>=threshold:
        num_rolls=0
